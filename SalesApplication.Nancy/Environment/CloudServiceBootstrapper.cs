...
{
    /// <summary>
    /// INancyBootstrapper to be used with SalesApplication.Azure.CloudService
    /// </summary>
    /// <remarks>Most bootstrapping logic is in base CustomBoostrapper class - all this one does is define a custom favicon</remarks>
    public sealed class CloudServiceBootstrapper : CustomBootstrapper
    {
        ...
        private byte[] LoadFavIcon()
        {
            ...
            using (var resourceStream = GetUIAssembly().GetManifestResourceStream("SalesApplication.UI.Images.Nancy.cloudServiceFavicon.png"))
            {
